...
【評価基準（項目別）】
各項目には以下の個別基準が設定されています。必ずこの基準に従って評価してください。
...
No.3 メールでのラリー回数は少なく、スムーズに日程調整ができた。
  〇：ラリー回数1〜2　△：ラリー回数2〜3　✕：3往復以上のラリー
  ✕の場合は備考に具体的内容を記載すること

No.4 問い合わせに対しての返信はテンプレートではなく自社に合わせた形での連絡だったか。
  〇：自社に合わせた返信　✕：テンプレートと判断できる

No.5 メールの文面は言葉遣いが丁寧で、誤字脱字がなく、不快感や違和感を感じるところはなかったか。
  〇：一切懸念なし　△：若干の懸念を感じる　✕：違和感・懸念を強く感じる
  △✕の場合は備考に具体的内容を記載すること
...
No.9 メールに事前質問は記載されていたか？
  〇：3つ以上の質問記載　△：〜3つ以内の質問記載　✕：質問記載なし
  備考に事前質問内容を添付すること

No.10 商談前のリマインド連絡があった。
  〇：前日と当日リマインド　△：当日リマインド　✕：リマインドなし
  備考にタイミングを記載すること
...
No.4〜11（会社の信頼性・サービス理解度・推薦意向等）
  〇：明確に確認できる　△：判断が難しい・一部確認できる　✕：確認できない・問題あり

上記の個別基準が設定されていない項目については以下の汎用基準を使用してください。
  〇：基準を満たしている／確認できる
  △：一部不足／判断が難しい
  ✕：基準未達／確認できない／問題あり

テキストから判断できない場合も「△」または「✕」を選択し、理由を備考に記載すること。
